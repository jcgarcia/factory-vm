...
Clone (or update if exists) and install:

```bash
[ -d factory-vm ] && (cd factory-vm && git pull) || git clone https://github.com/jcgarcia/factory-vm.git && cd factory-vm && ./setup-factory-vm.sh --auto
```
